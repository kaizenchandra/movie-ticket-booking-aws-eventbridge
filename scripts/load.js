...
export const options={thresholds:__ENV.EXPECT_OVERLOAD?{}:{checks:['rate>0.99'],rate_limited:['rate<0.01']},scenarios:{browse:{executor:'constant-vus',vus:10,duration:__ENV.DURATION||'30s',exec:'browse'},contention:{executor:'shared-iterations',vus:10,iterations:100,exec:'contention'}},summaryTrendStats:['avg','p(50)','p(95)','p(99)','max']};
